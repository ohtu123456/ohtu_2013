...
public class StorageDatabaseTest extends TestCase {
    ...
    public void testAfterCleanGetFilteredReturnsAll(){
        storageDatabase = new StorageDatabase(testDatabasePath);
        populateDatabase(storageDatabase);
        storageDatabase.addFilter("Mike");
        assertTrue(storageDatabase.getFiltered().size() == 1);
        storageDatabase.clearFilters();
        assertEquals(storageDatabase.getFiltered(), storageDatabase.getReferences());
    }
    ...
    public void testGetIdReturnsCorrectEntry(){
        storageDatabase = new StorageDatabase(testDatabasePath);
        populateDatabase(storageDatabase);
        Map<String, String> tulos = storageDatabase.getId("ÄÄRKERÄÄR");
        assertEquals(tulos.get("author"), "Mike Flynn");
    }
    
    public void testGetIdReturnsEmptyMapIfNoMatch(){
        storageDatabase = new StorageDatabase(testDatabasePath);
        populateDatabase(storageDatabase);
        Map<String, String> tulos = storageDatabase.getId("OLEMATON");
